...
/// </summary>
public sealed record WebAuthnTwoFactorResponse : TwoFactorResponse
{
...
/// </summary>
public sealed record WebAuthnRegisterOptionsResponse
{
...
/// </summary>
public sealed record WebAuthnLoginOptionsResponse
{
...
/// </summary>
public sealed record WebAuthnLoginCompleteResponse
{
...
/// </summary>
public sealed record WebAuthnValidateResponse
{
    public string Token { get; init; } = string.Empty;
    public UserDto User { get; init; } = new();
}
...
/// </summary>
public sealed record WebAuthnCredentialsResponse
{
...
/// </summary>
public sealed record WebAuthnRemoveCredentialResponse
{
