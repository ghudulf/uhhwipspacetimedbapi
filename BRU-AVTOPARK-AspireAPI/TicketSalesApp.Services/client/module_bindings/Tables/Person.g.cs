...
namespace SpacetimeDB.Types
{
    ...
    {
        public global::SpacetimeDB.Col<Person, int> Id { get; }
        public global::SpacetimeDB.Col<Person, string> Name { get; }
        public global::SpacetimeDB.Col<Person, int> Age { get; }

        public PersonCols(string tableName)
        {
            Id = new global::SpacetimeDB.Col<Person, int>(tableName, "id");
            Name = new global::SpacetimeDB.Col<Person, string>(tableName, "name");
            Age = new global::SpacetimeDB.Col<Person, int>(tableName, "age");
        }
    }

    public sealed class PersonIxCols
    {
        public global::SpacetimeDB.IxCol<Person, int> Id { get; }

        public PersonIxCols(string tableName)
        {
            Id = new global::SpacetimeDB.IxCol<Person, int>(tableName, "id");
        }
    }
}
